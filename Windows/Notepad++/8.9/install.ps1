...
$AppName = "Notepad++"
$Version = "8.9"
$VendorUrl = "https://github.com/notepad-plus-plus/notepad-plus-plus/releases/download/v8.9/npp.8.9.Installer.x64.exe"
$InstallerName = "npp.8.9.Installer.x64.exe"
$TempDir = "$env:TEMP\npp-install"
...
try {
    ...
    if ($WTF) {
        ...
        $manifestPath = "Windows/Notepad++/8.9/manifest.json"
