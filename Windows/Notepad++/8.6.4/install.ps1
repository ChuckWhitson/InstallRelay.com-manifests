...
$AppName = "Notepad++"
$Version = "8.6.4"
$VendorUrl = "https://github.com/notepad-plus-plus/notepad-plus-plus/releases/download/v8.6.4/npp.8.6.4.Installer.x64.exe"
$InstallerName = "npp.8.6.4.Installer.x64.exe"
$TempDir = "$env:TEMP\npp-install"
...
try {
    ...
    if ($WTF) {
        ...
        $manifestPath = "Windows/Notepad++/8.6.4/manifest.json"
