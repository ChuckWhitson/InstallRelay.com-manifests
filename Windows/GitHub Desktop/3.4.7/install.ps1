...
$Version = "3.4.7"
$VendorUrl = "https://central.github.com/deployments/desktop/desktop/latest/win32"
$InstallerName = "GitHubDesktopSetup-x64.exe"
$TempDir = "$env:TEMP\github-desktop-install"
...
try {
    ...
    if ($WTF) {
        ...
        $manifestPath = "Windows/GitHub Desktop/3.4.7/manifest.json"
