...
$Version = "7.10.0"
$VendorUrl = "https://downloads.realvnc.com/download/file/viewer.files/VNC-Viewer-7.10.0-Windows-64bit.exe"
$InstallerName = "VNC-Viewer-7.10.0-Windows-64bit.exe"
$TempDir = "$env:TEMP\realvnc-install"
...
try {
    ...
    # Download installer directly from RealVNC
    $InstallerPath = Join-Path $TempDir $InstallerName
    
    if ($WTF) {
        Write-Host "[WTF] Would download installer from RealVNC website..." -ForegroundColor Yellow
        ...
        Write-Host "Downloading installer from RealVNC website..." -ForegroundColor Yellow
        ...
        $manifestPath = "Windows/RealVNC Viewer/7.10.0/manifest.json"
