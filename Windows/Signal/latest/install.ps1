...
$AppName = "Signal"
$Version = "7.83.0"
$VendorUrl = "https://updates.signal.org/desktop/signal-desktop-win-7.83.0.exe"
$InstallerName = "signal-desktop-win-7.83.0.exe"
$TempDir = "$env:TEMP\signal-install"
...
try {
    ...
    if ($WTF) {
        Write-Host "[WTF] Would download installer from Signal..." -ForegroundColor Yellow
        ...
        Write-Host "[WTF] Would install using: $InstallerName --silent" -ForegroundColor Yellow
        Write-Host "[WTF] Installation test completed - no changes made" -ForegroundColor Green
    } else {
        Write-Host "Downloading installer from Signal..." -ForegroundColor Yellow
        ...
        $manifestPath = "Windows/Signal/7.83.0/manifest.json"
        ...
        Write-Host "Please open Signal and link it with your mobile device." -ForegroundColor Cyan
    }
}
catch {
