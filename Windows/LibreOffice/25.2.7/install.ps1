...
$AppName = "LibreOffice"
$Version = "25.2.7"
$VendorUrl = "https://download.libreoffice.org/libreoffice/stable/25.2.7/win/x86_64/LibreOffice_25.2.7_Win_x64.msi"
$InstallerName = "LibreOffice_25.2.7_Win_x64.msi"
