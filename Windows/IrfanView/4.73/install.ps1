...
if ($Arch -eq "ARM64") {
    $InstallerName = "iview473_arm64.exe"
    $VendorUrl = "https://www.irfanview.com/iview473_arm64.exe"
} elseif ($Arch -eq "AMD64" -or $Arch -eq "x64") {
    $InstallerName = "iview473_x64.exe"
    $VendorUrl = "https://www.irfanview.com/iview473_x64.exe"
} else {
    $InstallerName = "iview473_x32.exe"
    $VendorUrl = "https://www.irfanview.com/iview473_x32.exe"
}

$TempDir = "$env:TEMP\irfanview-install"
...
try {
    ...
    if ($WTF) {
        Write-Host "[WTF] Would download installer from irfanview.com..." -ForegroundColor Yellow
        ...
        Write-Host "Downloading installer from irfanview.com..." -ForegroundColor Yellow
        ...
        $manifestPath = "Windows/IrfanView/4.73/manifest.json"
        ...
        # IrfanView uses /S for silent install and /D for installation directory
        ...
        if ($Process.ExitCode -eq 0 -or $Process.ExitCode -eq $null) {
            ...
            Write-Host "IrfanView has been installed to: $InstallDir" -ForegroundColor Cyan
        } else {
