...
if ($Arch -eq "ARM64") {
    $InstallerName = "7z2501-arm64.exe"
    $VendorUrl = "https://sourceforge.net/projects/sevenzip/files/7-Zip/25.01/7z2501-arm64.exe/download"
} elseif ($Arch -eq "ARM") {
    $InstallerName = "7z2501-arm.exe"
    $VendorUrl = "https://sourceforge.net/projects/sevenzip/files/7-Zip/25.01/7z2501-arm.exe/download"
} else {
    $InstallerName = "7z2501-x64.exe"
    $VendorUrl = "https://sourceforge.net/projects/sevenzip/files/7-Zip/25.01/7z2501-x64.exe/download"
}

$TempDir = "$env:TEMP\7zip-install"
...
try {
    ...
    # Download installer directly from SourceForge
    $InstallerPath = Join-Path $TempDir $InstallerName
    
    if ($WTF) {
        Write-Host "[WTF] Would download installer from SourceForge..." -ForegroundColor Yellow
        ...
        Write-Host "Downloading installer from SourceForge..." -ForegroundColor Yellow
        ...
        $manifestPath = "Windows/7-Zip/25.01/manifest.json"
